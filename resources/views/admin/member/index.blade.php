...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card shadow mb-4">
            ...
            <form method="GET" action="{{ route('admin.member.pdf') }}">
                @csrf
                <button type="submit" class="btn btn-danger btn-block mt-2">Download PDF</button>
            </form>
            <form method="GET" action="{{ route('admin.member.excel') }}">
                @csrf
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="importForm" method="POST" action="{{ route('admin.member.import') }}" enctype="multipart/form-data">
                @csrf
