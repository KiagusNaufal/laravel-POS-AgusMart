...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('super.laporan.pembelian') }}">
                    <div class="row">
                        <div class="col-md-3">
                ...
                <form method="GET" action="{{ route('super.laporan.pembelian.pdf') }}">
                    @csrf
                ...
                <form method="GET" action="{{ route('super.laporan.pembelian.excel') }}">
                    @csrf
                    <input type="hidden" name="kode_masuk" value="{{ request('kode_masuk') }}">
                    <input type="hidden" name="start_date" value="{{ request('start_date') }}">
                    <input type="hidden" name="end_date" value="{{ request('end_date') }}">
